...
class DouyuUserAgentMiddleware(UserAgentMiddleware):
    def _init_(self,user_agent=""):
    ...
    def process_request(self, request, spider):
        ...
        request.headers.setdefault('Host','www.douyu.com')
        request.headers.setdefault('Referer','https://www.douyu.com/')
